...
const collectedItems = [
  ...
  "Billing and subscription data, including Dodo customer and subscription identifiers, plan, status, billing dates, and trial dates. Payment details are handled by Dodo Payments.",
...
const usageItems = [
  ...
  "Operate billing, subscriptions, trial access, credits, and transactional emails.",
